...
//        getSupportActionBar().setTitle(R.string.add_product);
        getSupportActionBar().setTitle(Html.fromHtml("<font color=\"#FFFFFF\">" + getString(R.string.add_product) + "</font>"));
        ...
        txtAddProdcut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (productName.isEmpty()) {
                    ...
                    addProduct(productName, productCode, productCategoryId, productDescription, productSellPrice, productWeight, productWeightUnitId, productSupplierId, productStock, tax, shopID, ownerId, productBuyPrice);
    ...
    private void addProduct(String productName, String productCode, String productCategoryId, String productDescription, String productSellPrice, String productWeight, String productWeightUnitId, String productSupplierId, String productStock, String tax, String shopId, String ownerId, String productBuyPrice) {
